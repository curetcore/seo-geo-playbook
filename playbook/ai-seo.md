...
> Cubre Answer Engine Optimization (AEO) y Generative Engine Optimization (GEO).
...
|---------|-------|--------|
| ChatGPT búsquedas/semana | +1 billon | OpenAI |
...
> Descripción breve del sitio (1-2 oraciones).
...
> Descripción del sitio en 1-2 oraciones. Que hace, para quien.
...
- [Docs](/docs): Documentacion técnica completa
...
|------|---------|----------------|
| Informational | "qué es INP" | Definición clara en primer parrafo |
...
la latencia de la interacción mas lenta del usuario durante la sesion.
...
```markdown
Según [SparkToro 2026], el 58.5% de las búsquedas en Google
...
3. Formato: titulo H1, descripción, secciones con links
...
|--------|-------------|---------|
| "Que es X" | `X es [definición]. [Contexto].` | "INP es una métrica que mide la interactividad. Reemplazó a FID en 2024." |
...
| "Cuánto cuesta X" | `X cuesta [rango]. [Factores que afectan precio].` | "Un SaaS básico cuesta $29-99/mes. El precio depende de features y usuarios." |
...
- [ ] BLUF: respuesta en primer parrafo de cada sección
