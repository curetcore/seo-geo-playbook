...
> Skill del agente `seo-marketing`. Cubre Google Search Console, Core Web Vitals monitoring, AI referral tracking, rank tracking, y cadencia de auditorias.
...
3. Solicitar indexacion de paginas criticas
...
| **Coverage/Indexing** | Paginas indexadas vs excluidas | Semanal | Fixear errores de indexacion |
| **Core Web Vitals** | LCP, INP, CLS por URL | Semanal | Optimizar paginas en rojo |
...
| Indexed pages | = paginas publicadas | Sitemap correcto, sin errores |
...
### Identificar trafico de AI search
...
| Categoria | Ejemplos | Frecuencia de tracking |
|-----------|----------|----------------------|
| Branded | "tuapp", "tuapp login" | Semanal |
| Non-branded head | "analytics ecommerce" | Semanal |
| Non-branded long tail | "como medir conversion rate ecommerce" | Quincenal |
...
- Filtrar por pagina especifica
- Comparar periodos (28d vs 28d anterior)
- Exportar CSV para tracking historico
```
...
2. Extraer sus top 50 paginas organicas
3. Categorizar por tema
4. Identificar temas que cubren y tu no
5. Priorizar por volumen de busqueda
...
- [ ] Analisis de keywords (ganando/perdiendo)
...
- [ ] Audit tecnico completo (squirrelscan)
- [ ] Content gap analysis vs competidores
- [ ] E-E-A-T review de paginas principales
