...
description: Audita un sitio completo con squirrelscan CLI — SEO, técnico, contenido, performance, seguridad, accessibility, schema y broken links (140+ reglas en 20 categorías). Returns LLM-optimized reports with health scores, broken links, meta tag analysis, and actionable recommendations. Use this skill whenever the user asks for a full site audit, mentions squirrelscan, wants an automated SEO audit, broken link check, lighthouse-style report, or site health score — even if they don't say "squirrelscan".
